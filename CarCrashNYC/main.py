...
DATA_URL = "C:\\Users\\Nate\\Desktop\\DataScienceApp\\Motor_Vehicle_Collisions_-_Crashes.csv"
...
st.header("The Highest Injury Count in New York City")
...
st.subheader(f"Breakdown by Minute {hour}:00 and {(hour + 1) % 24}:00")
filtered = data[
